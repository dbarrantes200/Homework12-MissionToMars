...
def scrape():
    ...
    executable_path = {'executable_path': 'C:/Users/dbarr/chromedriver.exe'}
...
# #### Mars Hemisperes
    ...
    url16="https://astrogeology.usgs.gov/search/results?q=hemisphere+enhanced&k1=target&v1=Mars"
    #Visit the page using the browser
    browser.visit(url16)
    time.sleep(1)
    # assign html content
